    ...
    <section className="bg-white py-16 md:py-20">
      <div className="container mx-auto px-4 max-w-7xl">
        <h2 className="text-3xl md:text-4xl font-bold text-[#1B3C53] text-center mb-12">
          {t('landing.testimonials_title', 'What Our Customers Say')}
        </h2>
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    {t('landing.testimonials_used_service', {
                      service: review.service_name,
                      defaultValue: `Used ${review.service_name} Service`,
                    })}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-200">
                ...
                <p className="text-xs text-gray-500">
                  {new Date(review.created_at).toLocaleDateString(i18n.language === 'ne' ? 'ne-NP' : 'en-IN')}
                </p>
              </div>
            </div>
          ))}
